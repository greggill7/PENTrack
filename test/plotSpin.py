...
def main():
    ...
    parser.add_argument("-n", "--neutron", type=int, help = "Look at one neutron (also finds adiabaticity)")
    ...
    parser.add_argument("-s", "--spin", action="store_true", help = "Makes a lot of sx, sy, sz plots")
    parser.add_argument("-td", "--threeD", action="store_true", help = "3d plot of sx, sy, sz")
    args = parser.parse_args()

    print("Use --help or -h to see optional arguments")
    if (args.file):
        filename = args.file
    else:
