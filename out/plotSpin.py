...
def main():
    ...
    parser.add_argument('-f', '--file', type=str, default='000000000000neutronspin.out', help = 'Text file (default 000000000000neutronspin.out)')
